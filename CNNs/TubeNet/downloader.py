...
def find_size(driver, lrow, lcol):
    # look for size
    val =  0
...
def main(driver, opt):
    cols = find_size(driver, 2, 100) + 1
    rows = find_size(driver, 100, 2) + 1
...
if __name__ == "__main__":
    ...
    parser.add_argument("-n", "--number", type=int, default=10, help="the number of thumbnails, views and titles it has to download")
